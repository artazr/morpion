module MorpionAlex2
  ...
  class Board 
    ...
    def initialize
      ...
      def find_best_box
        weight_computer_ref = [150, 500, 1200, 4000, 10000]
        weight_user_ref = [50, 200, 1000, 4000, 10000]
        weight_computer = [1, 3, 500, 1500, 100000]
        weight_user = [2, 4, 1000, 1200, 200000]
        weight_boxes = []
        (0..9).each do |i|
          (0..9).each do |j|
